...
- Path:
- Insights: networking by DMING people is essential, he has done the following below.
- go to linkedin for software company > people, people > search northeastern.
You'll see that amazon has top 5 northeasrtern students. THen if you search northeasrtern in that menu, you can see alum who work at that company, and you shpuld DM them (message examples below) (https://www.linkedin.com/company/amazon/people/?keywords=northeastern)
- Or go to khoury in linkedin, go to alumni, see where they go to work. that way you can see shich companies like hiring from northeastern. (https://www.linkedin.com/school/khoury-college/people/)
- Messaging good examples:
  1. Email 1 (good example)
